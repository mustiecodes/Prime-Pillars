...
function LoginPage() {
    ...
    const handleSubmit = async ()=>{
        const validationErrors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$validators$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginValidator"])(formData);
        if (Object.keys(validationErrors).length > 0) {
            setErrors(validationErrors);
            return;
        }
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])(formData);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success(res.message || 'Login successful');
            router.push('/');
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(err.message || 'Login failed');
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb769357._.js.map