...
"[project]/node_modules/jiti/dist/jiti.cjs [postcss] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    ...
    (()=>{
        ...
        const package_namespaceObject = {
            rE: "2.4.2"
        }, external_node_crypto_namespaceObject = __turbopack_context__.r("[externals]/node:crypto [external] (node:crypto, cjs)"), dist_r = Object.create(null), dist_i = (e)=>globalThis.process?.env || globalThis.Deno?.env.toObject() || globalThis.__env__ || (e ? dist_r : globalThis), dist_s = new Proxy(dist_r, {
